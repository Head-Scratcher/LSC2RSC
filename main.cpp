...
/* ========================================================================= */
  ...
  {  
    ...
    // NOW MAKE A CALL TO SOMETHING ELSE LIKE MQTT FROM HERE...
}

/* ========================================================================= */

void loop()  // For relay testing purposes only, will reset all relays in powerboard if connected!!!
{
...
void setup() // Only ever runs during initial firmware load, so be mindful of what you put in this function. Doesn't run during plugging in
{
