// Version 1.1 - Connnects the TinyPICO to a RaspberryPi4B over the GPIO pins to do serial communication. Note: Port and pin settings may vary between models. 
